<template>
  <div id="app" class="min-h-screen bg-gray-200 antialiased">
    ...
    <main class="py-6">
      <div class="px-4 ">
        <h3 class="text-gray-900 text-xl">Los Angles</h3>
        <p class="text-gray-600">Live like the stars in these luxurian Southerm California estates.</p>
      </div>

      <div class="mt-6 sm:overflow-x-auto">
        <div class="px-4 sm:flex sm:pb-8 sm:-mx-2">
          <div v-for="home in homes" :key="home.id" :class="{ 'mt-10': home.id > 1 }" class="sm:mt-0 sm:max-w-xs sm:w-full sm:flex-shrink-0 sm:px-2">
            <div class="relative pb-5/6">
              <img class="absolute inset-0 h-full rounded-lg shadow-md object-cover" src="https://images.unsplash.com/photo-1512917774080-9991f1c4c750?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80" alt="">
            </div>
...
export default {
  ...
  data: function() {
    return {
        homes: [
          { id: 1, title: 'Modern Home in city center'  },
          { id: 2, title: 'Modern Home in city center'  },
          { id: 3, title: 'Modern Home in city center'  },
          { id: 4, title: 'Modern Home in city center'  },
        ]
      };
  },
  components: {
