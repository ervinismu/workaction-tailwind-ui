<template>
  <div id="app" class="min-h-screen bg-gray-200 antialiased">
    ...
    <header class="flex justify-between bg-gray-900 px-4 py-3 items-center">
      <div>
    ...
    <section class="flex justify-between bg-gray-800 px-4 py-3">
      ...
      <button class="ml-4 inline-flex items-center hover:bg-gray-600 focus:outline-none focus:shadow-outline bg-gray-700 rounded-lg shadow pl-3 pr-4">
