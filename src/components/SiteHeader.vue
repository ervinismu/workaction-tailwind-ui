<template>
      ...
      <nav v-show="isOpen">
        <div class="px-2 pt-2 pb-5 border-b border-gray-800">
          <a href="#" class="font-semibold rounded px-3 py-1 block text-white hover:bg-gray-800">List your property</a>
          <a href="#" class="font-semibold rounded px-3 py-1 mt-1 block text-white hover:bg-gray-800">Trips</a>
          <a href="#" class="font-semibold rounded px-3 py-1 mt-1 block text-white hover:bg-gray-800">Messages</a>
        </div>
        <div class="px-5 py-5">
          <div class="flex items-center">
            ...
            <span class="text-gray-200 ml-2 font-semibold">Isla Schogar</span>
          </div>
          <div class="mt-5">
