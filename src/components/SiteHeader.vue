    ...
    <header class="bg-gray-900 sm:flex sm:items-center sm:justify-between xl:bg-white">
      ...
      <nav class="sm:block sm:flex sm:items-center sm:px-4 xl:flex-1 xl:justify-between" :class="{ 'hidden': !isOpen, 'block': isOpen }">
        ...
        <div class="sm:block sm:flex sm:items-center">
          ...
          <div class="relative px-5 py-5 sm:ml-4 sm:py-0 sm:px-0">
            ...
            <Dropdown class="hidden sm:block">
              ...
              <template v-slot:trigger="{ hasFocus, isOpen }">
                <span class="h-8 w-8 overflow-hidden block rounded-full border-2"
              ...
              <template v-slot:dropdown>
                <div class="mt-3 bg-white rounded-lg w-48 shadow-xl py-2 xl:border">
