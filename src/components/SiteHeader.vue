<template>
    <header class="bg-gray-900 sm:flex sm:items-center sm:justify-between">
      ...
      <nav class="sm:block sm:flex sm:items-center sm:px-4" :class="{ 'hidden': !isOpen, 'block': isOpen }">
        <div class="px-2 pt-2 pb-5 border-b border-gray-800 sm:flex sm:border-b-0 sm:py-0 sm:px-0">
          <a href="#" class="font-semibold rounded px-3 py-1 block text-white hover:bg-gray-800 sm:text-sm sm:px-2">List your property</a>
          <a href="#" class="font-semibold rounded px-3 py-1 mt-1 block text-white hover:bg-gray-800 sm:mt-0 sm:text-sm sm:px-2 sm:ml-2">Trips</a>
          <a href="#" class="font-semibold rounded px-3 py-1 mt-1 block text-white hover:bg-gray-800 sm:mt-0 sm:text-sm sm:px-2 sm:ml-2">Messages</a>
        </div>
        <div class="px-5 py-5 sm:ml-4 sm:py-0 sm:px-0">
          <div class="flex items-center">
            <img class="h-10 w-10 object-cover rounded-full border-2 border-gray-600 sm:h-8 sm:w-8" src="https://images.unsplash.com/photo-1487412720507-e7ab37603c6f?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=256&q=80" alt="">
            <span class="text-gray-200 ml-2 font-semibold sm:hidden">Isla Schogar</span>
          </div>
