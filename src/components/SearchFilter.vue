    ...
    <form v-show="isOpen">
      ...
      <div class="px-4 py-4 border-t border-gray-900">
        ...
        <div class="sm:flex sm:-mx-2">
          <label class="mt-3 flex items-center sm:w-1/4 sm:px-2" for="">
      ...
      <div class="px-4 py-4 border-t border-gray-900">
        ...
        <div class="sm:flex sm:-mx-2 sm:flex-wrap">
          ...
          <label class="mt-3 flex items-center sm:w-1/2 sm:px-2" for="">
      ...
      <div class="bg-gray-900 px-4 py-4 sm:text-right">
        <button class="block w-full bg-indigo-500 hover:bg-gray-400 font-semibold text-white px-4 py-2 rounded-lg sm:w-auto sm:inline-block">Update Result</button>
      </div>
    </form>
