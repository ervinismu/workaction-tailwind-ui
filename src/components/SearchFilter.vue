  ...
  <section class="bg-gray-800">
    ...
    <form v-show="isOpen">
      ...
      <fieldset class="px-4 py-4 border-t border-gray-900">
        ...
        <label class="mt-3 flex items-center" for="">
      ...
      <fieldset class="px-4 py-4 border-t border-gray-900">
        ...
        <label class="mt-3 flex items-center form-radio bg-gray-900" for="">
      ...
      <div class="bg-gray-900 px-4 py-4">
        <button class="block w-full bg-indigo-500 hover:bg-gray-400 font-semibold text-white px-4 py-2 rounded-lg">Update Result</button>
      </div>
    </form>
