  ...
  <div>
    <div>
      <div class="relative pb-5/6">
        <img class="absolute inset-0 h-full rounded-lg shadow-md object-cover" :src="property.imageUrl" alt="">
      </div>
        ...
        <div class="bg-white rounded-lg px-4 py-4 shadow-lg">
          <div class="flex">
            ...
            <div class="ml-2 text-xs text-gray-600 font-semibold uppercase tracking-wide">
              {{ property.beds }} {{ property.beds === 1 ? 'bed' : 'beds' }} &bull; {{ property.baths }} {{ property.beds === 1 ? 'bath' : 'baths' }}
            </div>
          </div>
          ...
          <div class="mt-2 flex items-center text-sm text-gray-600">
            <svg v-for="i in 5" :key="i" :class="property.rating >= i ? 'text-teal-500' : 'text-gray-400'" class="h-4 w-4 fill-current text-teal-500" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
